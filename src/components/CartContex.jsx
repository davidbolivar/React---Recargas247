...
export function CartProvider({ children }) {
	...
	const addToCart = (product, qty) => {
		...
		if (index >= 0) {
			...
			setCart([...cart]);
		} else setCart([...cart, { service_id: product.service_id, display_name: product.display_name.primary, qty, stock: product.stock, contract: product.contract, category: product.category }]);
	};
